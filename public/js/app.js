...
//     {id:1, title:"Winter's Bone", year:1991},
//     {id:2, title:'Gravity',year:1992},
//     {id:5, title:'Arrival',year:1993},
//     {id:6, title:'Wonder Woman',year:1994},
//     {id:8, title:'Get Out',year:1995}
// ];
...
function updateFilmList(films){
    ...
    films.forEach((film) => {
        ...
        filmLink.innerHTML = film.title + " " + film.year;

<x-layout title="Round8">
    <div class="track-container">
        <div class="track-box">
            <h1>{{ $track->title }}</h1>
            <h2>{{ $track->location }}</h2>
            <div class="layout">
                <img src="{{ asset('images/irwidale.png') }}" alt="Irwindale track layout">
            </div>
            <a href="https://www.google.co.uk/maps/place/Irwindale+Speedway/@34.110441,-117.9899454,17z/data=!3m1!4b1!4m6!3m5!1s0x80c2d9c707ccf179:0x3df3e4320e615571!8m2!3d34.1104366!4d-117.9873705!16zL20vMDJnZzhu?entry=ttu&g_ep=EgoyMDI1MDQxNi4xIKXMDSoASAFQAw%3D%3D" target="_blank" class="buttons">Find on Maps</a>

<x-layout title="Round4">
    <div class="track-container">
        <div class="track-box">
            <h1>{{ $track->title }}</h1>
            <h2>{{ $track->location }}</h2>
            <div class="layout">
                <img src="{{ asset('images/e-town.png') }}" alt="Englishtown track layout">
            </div>
            <a href="https://www.google.co.uk/maps/place/Old+Bridge+Township+Raceway+Park+Inc/@40.3346369,-74.3542213,17z/data=!3m1!4b1!4m6!3m5!1s0x89c3d1190ca4f823:0x1d68518d4c90e2a8!8m2!3d40.3346328!4d-74.3516464!16s%2Fm%2F047st_w?entry=ttu&g_ep=EgoyMDI1MDQxNi4xIKXMDSoASAFQAw%3D%3D" target="_blank" class="buttons">Find on Maps</a>

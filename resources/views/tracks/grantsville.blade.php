<x-layout title="Round7">
    <div class="track-container">
        <div class="track-box">
            <h1>{{ $track->title }}</h1>
            <h2>{{ $track->location }}</h2>
            <div class="layout">
                <img src="{{ asset('images/grantsville.png') }}" alt="Grantsville track layout">
            </div>
            <a href="https://www.google.co.uk/maps/place/Utah+Motorsports+Campus/@40.5848068,-112.3759819,17z/data=!3m1!4b1!4m6!3m5!1s0x8752b90dfd00891b:0x133bf2cf725d251a!8m2!3d40.5848028!4d-112.373407!16zL20vMGZqaDN5?entry=ttu&g_ep=EgoyMDI1MDQxNi4xIKXMDSoASAFQAw%3D%3D" target="_blank" class="buttons">Find on Maps</a>

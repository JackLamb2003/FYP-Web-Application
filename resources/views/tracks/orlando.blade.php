<x-layout title="Round3">
    <div class="track-container">
        <div class="track-box">
            <h1>{{ $track->title }}</h1>
            <h2>{{ $track->location }}</h2>
            <div class="layout">
                <img src="{{ asset('images/orlando.png') }}" alt="Orlando track layout">
            </div>
            <a href="https://www.google.co.uk/maps/place/Orlando+Speed+World/@28.5405035,-81.0956878,17z/data=!4m14!1m7!3m6!1s0x88e75c941b84957b:0xf81a2767a95c0a2c!2sOrlando+Speed+World+Oval+Track!8m2!3d28.5387397!4d-81.0924043!16s%2Fg%2F11d_7_yyxf!3m5!1s0x88e75cbdd4bd99c9:0xbf45f38acc25a69e!8m2!3d28.5433448!4d-81.0937041!16s%2Fg%2F12q4wkx4t?entry=ttu&g_ep=EgoyMDI1MDQxNi4xIKXMDSoASAFQAw%3D%3D" target="_blank" class="buttons">Find on Maps</a>

<x-layout title="Round2">
    <div class="track-container">
        <div class="track-box">
            <h1>{{ $track->title }}</h1>
            <h2>{{ $track->location }}</h2>
            <div class="layout">
                <img src="{{ asset('images/atlanta.png') }}" alt="Atlanta track layout">
            </div>
            <a href="https://www.google.co.uk/maps/place/Michelin+Raceway+Road+Atlanta/@34.1522331,-83.8176048,17z/data=!3m1!4b1!4m6!3m5!1s0x88f5ee17cbf92445:0xb9a57dadc2511f35!8m2!3d34.1522287!4d-83.8150299!16zL20vMDVrZGZ0?entry=ttu&g_ep=EgoyMDI1MDQxNi4xIKXMDSoASAFQAw%3D%3D" target="_blank" class="buttons">Find on Maps</a>

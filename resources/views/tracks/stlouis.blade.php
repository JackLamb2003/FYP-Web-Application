<x-layout title="Round5">
    <div class="track-container">
        <div class="track-box">
            <h1>{{ $track->title }}</h1>
            <h2>{{ $track->location }}</h2>
            <div class="layout">
                <img src="{{ asset('images/stlouis.png') }}" alt="StLouis track layout">
            </div>
            <a href="https://www.google.co.uk/maps/place/World+Wide+Technology+Raceway/@38.6507585,-90.1379298,17z/data=!3m1!4b1!4m6!3m5!1s0x87d8ad4926cfeeff:0xdf6e5263c5504342!8m2!3d38.6507543!4d-90.1353549!16zL20vMDRmZGdu?entry=ttu&g_ep=EgoyMDI1MDQxNi4xIKXMDSoASAFQAw%3D%3D" target="_blank" class="buttons">Find on Maps</a>

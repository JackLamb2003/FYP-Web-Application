<x-layout title="Round1">
    <div class="track-container">
        <div class="track-box">
            <h1>{{ $track->title }}</h1>
            <h2>{{ $track->location }}</h2>
            <div class="layout">
                <img src="{{ asset('images/longbeach.png') }}" alt="Longbeach track layout">
            </div>
            <a href="https://www.google.co.uk/maps/place/Long+Beach+Convention+%26+Entertainment+Center/@33.7656608,-118.1940063,16z/data=!4m6!3m5!1s0x80dd313b68c4eae7:0x69f1fff3cb508d42!8m2!3d33.7648004!4d-118.1893688!16zL20vMDczOGwy?entry=ttu&g_ep=EgoyMDI1MDQxNi4xIKXMDSoASAFQAw%3D%3D" target="_blank" class="buttons">Find on Maps</a>
